...
class Client$1 {
    ...
    static get(url, connectionTimeout = 4000, responseTimeout = 4000, authorization = null){
        let headers = Client$1.getHeader(authorization);
        var params =  {
            headers: headers,
            method: 'GET',
     ...
     */
     load(name, url) {
        ...
        return new Promise((resolve) => {
            Client$1.get(url).then((response) => {
                if(!response.ok){
