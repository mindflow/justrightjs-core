...
class ElementUtils {
    ...
    static createFromXmlElement(xmlElement, parentElement) {
        ...
        if (parentElement && parentElement.mappedElement !== null) {
            containerbridge_v1.ContainerElementUtils.appendChild(parentElement.mappedElement, element);
        }
        xmlElement.attributes.forEach((attributeKey, attribute) => {
            containerbridge_v1.ContainerElementUtils.setAttribute(element, attributeKey, attribute.value);
            return true;
        });
        return element;
    }
...
class BaseElement extends MappedHtmlElement {
    ...
    listenTo(eventType, listener, capture) {
        containerbridge_v1.ContainerElementUtils.addEventListener(super.mappedElement, eventType, (event) => {
    ...
    setAttributeValue(key,value) {
        containerbridge_v1.ContainerElementUtils.setAttribute(super.mappedElement, key,value);
    }

    getAttributeValue(key) {
        return containerbridge_v1.ContainerElementUtils.getAttribute(super.mappedElement, key);
    }
    ...
    set(input) {
        ...
        if(typeof input == "string") {
            super.mappedElement.parentNode.replaceChild(containerbridge_v1.ContainerElementUtils.createTextNode(input), super.mappedElement);
            return;
        }
    ...
    addChild(input) {
        ...
        if (typeof input == "string") {
            super.mappedElement.appendChild(containerbridge_v1.ContainerElementUtils.createTextNode(input));
            return;
        }
        if (input instanceof Text) {
    ...
    prependChild(input) {
        ...
        if (typeof input == "string") {
            super.mappedElement.insertBefore(containerbridge_v1.ContainerElementUtils.createTextNode(input), super.mappedElement.firstChild);
            return;
        }
        if (input instanceof Text) {
...
class TextnodeElement {
    ...
    constructor(value, parent) {
        ...
        if(typeof value === "string"){
            this.element = containerbridge_v1.ContainerElementUtils.createTextNode(value);
        }
    }
...
class CanvasRoot {
    ...
    static addHeaderElement(element) {
        containerbridge_v1.ContainerElementUtils.appendRootMetaChild(element.mappedElement);
    }
    ...
    static addBodyElement(element) {
        containerbridge_v1.ContainerElementUtils.appendRootUiChild(element.mappedElement);
    }
    ...
    static prependHeaderElement(element) {
        containerbridge_v1.ContainerElementUtils.prependElement("head", element.mappedElement);
    }
    ...
    static prependBodyElement(element) {
        containerbridge_v1.ContainerElementUtils.prependElement("body", element.mappedElement);
    }
    ...
    static listenToFocusEscape(listener, focusRoot) {
        ...
        const callIfNotContains = new coreutil_v1.Method(null, (event) => {
            ...
            if (containerbridge_v1.ContainerElementUtils.contains(focusRoot.element, CanvasRoot.mouseDownElement.element)) {
                return;
            }
            // If the element is not connected, then the element is not visible
            // and we should not trigger focus escape events
            if (!containerbridge_v1.ContainerElementUtils.isConnected(CanvasRoot.mouseDownElement.element)) {
                return;
            }
