...
class Application extends ModuleRunner {
     ...
     * @param {Config} config 
     */
    constructor(moduleLoaderArray, workerArray = new Array(), config = new mindi_v1.MindiConfig()) {
