...
const LOG$6 = new coreutil_v1.Logger("LoaderInterceptor");
...
class LoaderInterceptor {
     ...
     */
    process() {
        LOG$6.info("Unimplemented Loader Interceptor breaks by default");
        return false;
    }

}

const LOG$5 = new coreutil_v1.Logger("ModuleLoader");
...
class ModuleLoader {
    ...
    async load() {
        try {
            ...
            LOG$5.warn("Filter rejected " + reason);
            return null;
        }
    }
...
const LOG$4 = new coreutil_v1.Logger("DiModuleLoader");
...
class DiModuleLoader extends ModuleLoader {
    ...
    async load() {
        try {
            ...
            LOG$4.warn("Module loader failed " + reason);
            throw reason;
        }
    }
