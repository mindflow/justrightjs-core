    ...
    go() {
        this.download().then(() => {
            this.filtersPass().then(() => {
                ...
                LOG$f.warn("Filter rejected " + reason);
            });
        });
    }
            ...
            return super.importModule().then(() => {
                ...
                this.config.finalize().then(() => {
                    new coreutil_v1.List(this.loaderInterceptors).promiseChain((loaderInterceptor) => {
                        ...
                        mindi_v1.MindiInjector.inject(this.defaultInstance, this.config).then(() => {
                            resolve();
                        });
                    });
                });
